...
public class TestTelegrams extends TestCase{
	...
	public void testStartMesure(){
		...
		assertTrue(start.equals(START+"sMN LMCstartmeas"+END));
	...
	public void testStopMesure(){
		...
		assertTrue(stop.equals(START+"sMN LMCstopmeas"+END));
	...
	public void testGetStatus(){
		...
		assertTrue(status.equals(START+"sRN STlms"+END));
	...
	public void testGetScanData(){
		...
		assertTrue(data.equals(START+"sEN LMDscandata 1"+END));
